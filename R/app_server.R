  ...
  observeEvent(input$PMHselector,{
    ...
    observeEvent(input$OffCampus,{
      ...
      if(input$OffCampus == F) {
        ...
        mod_info_server('IOOV', selector=selction, data=PMHdata(), rownametitle=c("In Our Own Voices"), phone=T, website = T, email = F)
        mod_info_server('SHAPE',selector=selection, data=PMHdata(), rownametitle=c("Project SHAPE (Sexual Health and Peer Education)"), phone=T, website = T, email = F)
        mod_info_server('ELLIS',selector=selection, data=PMHdata(), rownametitle=c("Ellis Medicine Medicaid/Health Insurance Programs"), phone=T, website = T, email = F)
        mod_info_server('AMC',selector=selection, data=PMHdata(), rownametitle=c("Albany Medical Center"), phone=T, website = T, email = F)
        mod_info_server('AMCwash',selector=selection, data=PMHdata(), rownametitle=c("Albany Med (Washington Ave)"), phone=T, website = T, email = F)
        ...
        mod_info_server('FHF_CapCityRunners', selector = selection, data = PMHdata(), rownametitle = c('Cap City Runners'), phone = F, website = T, email = F)
        ...
        mod_info_server('FHF_PaceHappinessRunClub', selector = selection, data = PMHdata(), rownametitle = c('Pace and Happiness Run Club'), phone = F, website = T, email = F)
        mod_Accordion_server('FHF_AlbRunExchange', selector=selection, data=PMHdata(), title = c('Albany Running Exchange'), Visible = F)
        mod_info_server('FHF_AlbRunExchange', selector = selection, data = PMHdata(), rownametitle = c('Albany Running Exchange'), phone = F, website = T, email = F)
    ...
    # MH Accordion ------------------------------------------------------------
      ...
      observeEvent(input$OffCampus,{
        ...
        if(input$OffCampus == F) {
          ...
          mod_info_server('MH_CHAMP', selector = selection, data = MHdata(), rownametitle = c('CHAMP Program (OASAS)'), phone = T, website = T, email = F)
          mod_Accordion_server('MH_PSC', selector=selection, data=MHdata(), title = c('Psychological Services Center (PSC)'), Visible = F)
          mod_info_server('MH_PSC', selector = selection, data = MHdata(), rownametitle = c('Psychological Services Center (PSC)'), phone = T, website = T, email = F)
    ...
    # MH Black Communities ----------------------------------------------------
      ...
      mod_info_server('akkoma', selector = selection, data = MHBC(), rownametitle = c('AAKOMA Project'), phone = F, website = T, email = F)
      mod_Accordion_server('BEAM', selector=selection, data=MHBC(), title = c('Black Mental Wellness'), Visible = T)
      mod_info_server('BEAM', selector = selection, data = MHBC(), rownametitle = c('Black Emotional and Mental Health Collective (BEAM)'), phone = F, website = T, email = F)
      mod_Accordion_server('BLHF', selector=selection, data=MHBC(), title = c('The Boris Lawrence Henson Foundation'), Visible = T)
      mod_info_server('BLHF', selector = selection, data = MHBC(), rownametitle = c('The Boris Lawrence Henson Foundation'), phone = F, website = T, email = F)
      mod_Accordion_server('BROMM', selector=selection, data=MHBC(), title = c('Brother, You are on My Mind'), Visible = T)
      mod_info_server('BROMM', selector = selection, data = MHBC(), rownametitle = c('Brother, You are on My Mind'), phone = F, website = T, email = F)
      mod_Accordion_server('MHBCinsclusivetherapists', selector=selection, data=MHBC(), title = c('Inclusive Therapists'), Visible = T)
      mod_info_server('MHBCinsclusivetherapists', selector = selection, data = MHBC(), rownametitle = c('Inclusive Therapists'), phone = F, website = T, email = F)
      mod_Accordion_server('Loveland', selector=selection, data=MHBC(), title = c('The Loveland Foundation'), Visible = T)
      mod_info_server('Loveland', selector = selection, data = MHBC(), rownametitle = c('The Loveland Foundation'), phone = F, website = T, email = F)
      mod_Accordion_server('MalaninandMH', selector=selection, data=MHBC(), title = c('Melanin and Mental Health'), Visible = T)
      mod_info_server('MalaninandMH', selector = selection, data = MHBC(), rownametitle = c('Melanin and Mental Health'), phone = F, website = T, email = F)
      mod_Accordion_server('POCagainstsuicide', selector=selection, data=MHBC(), title = c('People of Color Against Suicide'), Visible = T)
      mod_info_server('POCagainstsuicide', selector = selection, data = MHBC(), rownametitle = c('National Organization for People of Color Against Suicide'), phone = F, website = T, email = F)
      mod_Accordion_server('Qttoc', selector=selection, data=MHBC(), title = c('Queer & Trans Therapists of Color'), Visible = T)
      mod_info_server('Qttoc', selector = selection, data = MHBC(), rownametitle = c('National Queer & Trans Therapists of Color Network'), phone = F, website = T, email = F)
      mod_Accordion_server('TherapyBlackGirls', selector=selection, data=MHBC(), title = c('Therapy for Black Girls'), Visible = T)
      mod_info_server('TherapyBlackGirls', selector = selection, data = MHBC(), rownametitle = c('Therapy for Black Girls'), phone = F, website = T, email = F)
      mod_Accordion_server('TherapyBlackMen', selector=selection, data=MHBC(), title = c('Therapy for Black Men'), Visible = T)
      mod_info_server('TherapyBlackMen', selector = selection, data = MHBC(), rownametitle = c('Therapy for Black Men'), phone = F, website = T, email = F)
    ...
    if(input$PMHselector == "MH Resources (Hispanic Communities)"){
      ...
      mod_info_server('CDLatinos', selector = selection, data = MHLC(), rownametitle = c('Capital District Latinos'), phone = F, website = T, email = F)
      mod_Accordion_server('MHLCInclusiveTherapists', selector=selection, data=MHLC(), title = c('Inclusive Therapists'), Visible = T)
      mod_info_server('MHLCInclusiveTherapists', selector = selection, data = MHLC(), rownametitle = c('Inclusive Therapists'), phone = F, website = T, email = F)
      mod_Accordion_server('LifeisPrecious', selector=selection, data=MHLC(), title = c('Life is Precious'), Visible = T)
      mod_info_server('LifeisPrecious', selector = selection, data = MHLC(), rownametitle = c('Life is Precious'), phone = F, website = T, email = F)
      mod_Accordion_server('LatinXtherapy', selector=selection, data=MHLC(), title = c('Latinx Therapy'), Visible = T)
      mod_info_server('LatinXtherapy', selector = selection, data = MHLC(), rownametitle = c('Latinx Therapy'), phone = F, website = T, email = F)
      mod_Accordion_server('NatnlLatinaOrg', selector=selection, data=MHLC(), title = c('National Latina Organization'), Visible = T)
      mod_info_server('NatnlLatinaOrg', selector = selection, data = MHLC(), rownametitle = c('MANA, A National Latina Organization'), phone = F, website = T, email = F)
      mod_Accordion_server('NatlAllianceHispHealth', selector=selection, data=MHLC(), title = c('Alliance for Hispanic Health'), Visible = T)
      mod_info_server('NatlAllianceHispHealth', selector = selection, data = MHLC(), rownametitle = c('National Alliance for Hispanic Health'), phone = F, website = T, email = F)
      mod_Accordion_server('LatinxPsychAssociation', selector=selection, data=MHLC(), title = c('Latinx Psych Association'), Visible = T)
      mod_info_server('LatinxPsychAssociation', selector = selection, data = MHLC(), rownametitle = c('National Latinx Psychological Association'), phone = F, website = T, email = F)
      ...
      mod_info_server('MHLCpocagainstsuicide', selector = selection, data = MHLC(), rownametitle = c('National Organization for People of Color Against Suicide'), phone = F, website = T, email = F)
      ...
      mod_info_server('MHLCqtTherapistsofColor', selector = selection, data = MHLC(), rownametitle = c('National Queer & Trans Therapists of Color Network'), phone = F, website = T, email = F)
    ...
    if(input$PMHselector == "LGBTQ+ Resources"){
      ...
      observeEvent(input$OffCampus,{
        ...
        if(input$OffCampus == F) {
          ...
          mod_info_server('LGB_pridecenter', selector = selection, data = SLGBT(), rownametitle = c('Pride Center of the Capital Region'), phone = T, website = T, email = F)
          mod_Accordion_server('LBG_IOOV', selector=selection, data=SLGBT(), title = c('In Our Own Voices'), Visible = F)
          mod_info_server('LBG_IOOV', selector = selection, data = SLGBT(), rownametitle = c('In Our Own Voices'), phone = T, website = T, email = F)
          mod_Accordion_server('LGB_APH', selector=selection, data=SLGBT(), title = c('Alliance for Positive Health'), Visible = F)
          mod_info_server('LGB_APH', selector = selection, data = SLGBT(), rownametitle = c('Alliance for Positive Health'), phone = T, website = T, email = F)
          mod_Accordion_server('LGB_DamienCenter', selector=selection, data=SLGBT(), title = c('Damien Center'), Visible = F)
          mod_info_server('LGB_DamienCenter', selector = selection, data = SLGBT(), rownametitle = c('Damien Center'), phone = T, website = T, email = F)
          mod_Accordion_server('LGB_UHPP', selector=selection, data=SLGBT(), title = c('Upper Hudson Planned Parenthood'), Visible = F)
          mod_info_server('LGB_UHPP', selector = selection, data = SLGBT(), rownametitle = c('Upper Hudson Planned Parenthood'), phone = T, website = T, email = F)
          mod_Accordion_server('LGB_InclusiveTherapists', selector=selection, data=SLGBT(), title = c('Inclusive Therapists'), Visible = F)
          mod_info_server('LGB_InclusiveTherapists', selector = selection, data = SLGBT(), rownametitle = c('Inclusive Therapists'), phone = F, website = T, email = F)
          ...
          mod_info_server('LGB_Qttherapistsofcolor', selector = selection, data = SLGBT(), rownametitle = c('National Queer & Trans Therapists of Color Network'), phone = F, website = T, email = F)
          mod_Accordion_server('LGB_SHAPE', selector=selection, data=SLGBT(), title = c('Project SHAPE'), Visible = T)
          mod_info_server('LGB_SHAPE', selector = selection, data = SLGBT(), rownametitle = c('Project SHAPE (Sexual Health and Peer Education)'), phone = T, website = T, email = F)
          mod_Accordion_server('LGB_LegalAIDNENY', selector=selection, data=SLGBT(), title = c('Legal Aid of NE New York'), Visible = F)
          mod_info_server('LGB_LegalAIDNENY', selector = selection, data = SLGBT(), rownametitle = c('Legal Aid Society Northeastern New York'), phone = T, website = T, email = F)
          mod_Accordion_server('LGB_StudentLegal', selector=selection, data=SLGBT(), title = c('Student Legal Services'), Visible = T)
          mod_info_server('LGB_StudentLegal', selector = selection, data = SLGBT(), rownametitle = c('Student Legal Services'), phone = T, website = T, email = F)
          ...
          mod_info_server('LGBTQ_SuicideLifeline', selector = selection, data = SLGBT(), rownametitle = c('(988) National Suicide & Crisis Lifeline'), phone = T, website = T, email = F)
          mod_Accordion_server('LGBTQ_TrevorProject', selector=selection, data=SLGBT(), title = c('The Trevor Project'), Visible = F)
          mod_info_server('LGBTQ_TrevorProject', selector = selection, data = SLGBT(), rownametitle = c('The Trevor Project'), phone = T, website = T, email = F)
    ...
    if(input$PMHselector == "Sexual Health"){
      ...
      observeEvent(input$OffCampus,{
        ...
        if(input$OffCampus == F) {
          ...
          mod_info_server('SH_SHS', selector = selection, data = HIVSTI(), rownametitle = c('Student Health Services'), phone = T, website = T, email = F)
          mod_Accordion_server('SH_APH', selector=selection, data=HIVSTI(), title = c('Alliance for Positive Health'), Visible = F)
          mod_info_server('SH_APH', selector = selection, data = HIVSTI(), rownametitle = c('Alliance for Positive Health'), phone = T, website = T, email = F)
          mod_Accordion_server('SH_AMC', selector=selection, data=HIVSTI(), title = c('Albany Med Young Adult Program'), Visible = F)
          mod_info_server('SH_AMC', selector = selection, data = HIVSTI(), rownametitle = c('Albany Med Young Adult Program'), phone = T, website = T, email = F)
          mod_Accordion_server('SH_DamienCenter', selector=selection, data=HIVSTI(), title = c('Damien Center'), Visible = F)
          mod_info_server('SH_DamienCenter', selector = selection, data = HIVSTI(), rownametitle = c('Damien Center'), phone = T, website = T, email = F)
          mod_Accordion_server('SH_UHPP', selector=selection, data=HIVSTI(), title = c('Upper Hudson Planned Parenthood'), Visible = F)
          mod_info_server('SH_UHPP', selector = selection, data = HIVSTI(), rownametitle = c('Upper Hudson Planned Parenthood'), phone = T, website = T, email = F)
          mod_Accordion_server('SH_PrideCenter', selector=selection, data=HIVSTI(), title = c('Pride Center of the Capital Region'), Visible = F)
          mod_info_server('SH_PrideCenter', selector = selection, data = HIVSTI(), rownametitle = c('Pride Center of the Capital Region'), phone = T, website = T, email = F)
          mod_Accordion_server('SH_WYH', selector=selection, data=HIVSTI(), title = c('Whitney Young Health'), Visible = F)
          mod_info_server('SH_WYH', selector = selection, data = HIVSTI(), rownametitle = c('Whitney Young Health'), phone = T, website = T, email = F)
    ...
    if(input$PMHselector == "Sexual Violence Related"){
      ...
      observeEvent(input$OffCampus,{
        ...
        if(input$OffCampus == F) {
          ...
          mod_info_server('SV_SLS', selector = selection, data = SVdata(), rownametitle = c('Student Legal Services'), phone = T, website = T, email = F)
          ...
          mod_info_server('SV_SVsupportAdvocacy', selector = selection, data = SVdata(), rownametitle = c('Sexual Violence Support & Advocacy Services'), phone = T, website = T, email = F)
          ...
          mod_info_server('SV_24hrSexualAssaultHotline', selector = selection, data = SVdata(), rownametitle = c('24-Hour Sexual Assault Hotline'), phone = T, website = T, email = F)
          mod_Accordion_server('SV_RAINN', selector=selection, data=SVdata(), title = c('RAINN Sexual Violence'), Visible = F)
          mod_info_server('SV_RAINN', selector = selection, data = SVdata(), rownametitle = c('RAINN Sexual Violence'), phone = T, website = T, email = F)
          ...
          mod_info_server('SV_Svcenter', selector = selection, data = SVdata(), rownametitle = c('Crime Victim and Sexual Violence Center'), phone = T, website = T, email = F)
          ...
          mod_info_server('SV_TittleIX', selector = selection, data = SVdata(), rownametitle = c('Title IX'), phone = T, website = T, email = F)
          mod_Accordion_server('SV_SAFEKits', selector=selection, data=SVdata(), title = c('SAFE Kits'), Visible = T)
          mod_info_server('SV_SAFEKits', selector = selection, data = SVdata(), rownametitle = c('SAFE Kits'), phone = F, website = T, email = F)
    ...
    if(input$PMHselector == "Interpartner Violence"){
      ...
      observeEvent(input$OffCampus,{
        ...
        if(input$OffCampus == F) {
          ...
          mod_info_server('IPV_Office of Health Promotion', selector = selection, data = IPVdata(), rownametitle = c('UAlbany Office of Health Promotion'), phone = T, website = T, email = F)

          mod_Accordion_server('IPV_Equinox', selector=selection, data=IPVdata(), title = c('Equinox'), Visible = F)
          mod_info_server('IPV_Equinox', selector = selection, data = IPVdata(), rownametitle = c('Equinox'), phone = T, website = F, email = F)
          ...
          mod_info_server('IPV_Crime Victim and Sexual Violence Center', selector = selection, data = IPVdata(), rownametitle = c('Crime Victim and Sexual Violence Center'), phone = T, website = T, email = F)
          ...
          mod_info_server('IPV_Equinox', selector = selection, data = IPVdata(), rownametitle = c('Equinox'), phone = T, website = T, email = F)
    ...
    if(input$PMHselector == "Alcohol and Other Drugs"){
      ...
      observeEvent(input$OffCampus,{
        ...
        if(input$OffCampus == F) {
          ...
          mod_info_server('AOD_OHP', selector = selection, data = AODdata(), rownametitle = c('Collegiate Recovery Program'), phone = T, website = T, email = F)
          mod_Accordion_server('AOD_NUA', selector=selection, data=AODdata(), title = c('Never Use Alone (English)'), Visible = F)
          mod_info_server('AOD_NUA', selector = selection, data = AODdata(), rownametitle = c('Never Use Alone (English)'), phone = T, website = T, email = F)
          mod_Accordion_server('AOD_NUAspanish', selector=selection, data=AODdata(), title = c('Never Use Alone (Spanish)'), Visible = F)
          mod_info_server('AOD_NUAspanish', selector = selection, data = AODdata(), rownametitle = c('Never Use Alone (Spanish)'), phone = T, website = T, email = F)
          mod_Accordion_server('AOD_BraveAPP', selector=selection, data=AODdata(), title = c('The Brave App'), Visible = F)
          mod_info_server('AOD_BraveAPP', selector = selection, data = AODdata(), rownametitle = c('The Brave App'), phone = F, website = T, email = F)
          mod_Accordion_server('AOD_Equinox', selector=selection, data=AODdata(), title = c('Equinox'), Visible = F)
          mod_info_server('AOD_Equinox', selector = selection, data = AODdata(), rownametitle = c('Equinox'), phone = T, website = T, email = F)
          mod_Accordion_server('AOD_ACCAlbany', selector=selection, data=AODdata(), title = c('Addictions Care Center of Albany'), Visible = F)
          mod_info_server('AOD_ACCAlbany', selector = selection, data = AODdata(), rownametitle = c('Addictions Care Center of Albany'), phone = T, website = T, email = F)
          mod_Accordion_server('AOD_OASASlocator', selector=selection, data=AODdata(), title = c('OASAS Treatment Locator'), Visible = F)
          mod_info_server('AOD_OASASlocator', selector = selection, data = AODdata(), rownametitle = c('OASAS Treatment Locator'), phone = T, website = T, email = F)
          mod_Accordion_server('AOD_NaloxoneCal', selector=selection, data=AODdata(), title = c('OASAS Naloxone Training Calendar'), Visible = F)
          mod_info_server('AOD_NaloxoneCal', selector = selection, data = AODdata(), rownametitle = c('OASAS Naloxone Training Calendar'), phone = F, website = T, email = F)
          mod_Accordion_server('AOD_SMART', selector=selection, data=AODdata(), title = c('SMART Recovery Meetings'), Visible = F)
          mod_info_server('AOD_SMART', selector = selection, data = AODdata(), rownametitle = c('SMART Recovery Meetings'), phone = F, website = T, email = F)
          mod_Accordion_server('AOD_Refuge', selector=selection, data=AODdata(), title = c('Refuge Recovery Meetings'), Visible = F)
          mod_info_server('AOD_Refuge', selector = selection, data = AODdata(), rownametitle = c('Refuge Recovery Meetings'), phone = F, website = T, email = F)
          mod_Accordion_server('AOD_Aameetings', selector=selection, data=AODdata(), title = c('AA Meetings'), Visible = F)
          mod_info_server('AOD_Aameetings', selector = selection, data = AODdata(), rownametitle = c('AA Meetings'), phone = F, website = T, email = F)
          ...
          mod_info_server('AOD_CampusDrugPrevINDEX', selector = selection, data = AODdata(), rownametitle = c('Drug Index (CampusDrugPrevention.gov)'), phone = F, website = T, email = F)
          ...
          mod_info_server('AOD_NYSQuitline', selector = selection, data = AODdata(), rownametitle = c('NY Quits - Smokers Quit Line'), phone = T, website = T, email = F)
    ...
    if(input$PMHselector == "Problem Gambling"){
      ...
      mod_info_server('GAMB_NYSmainwebsite', selector = selection, data = GAMBdata(), rownametitle = c('NYS Problem Gambling Help'), phone = F, website = T, email = F)
      mod_Accordion_server('GAMB_Escreener', selector=selection, data=GAMBdata(), title = c('NYS Gambling E-Screener'), Visible = T)
      mod_info_server('GAMB_Escreener', selector = selection, data = GAMBdata(), rownametitle = c('NYS Gambling E-Screener'), phone = F, website = T, email = F)
      mod_Accordion_server('GAMB_NYShotline', selector=selection, data=GAMBdata(), title = c('New York State Gamblers Hotline'), Visible = T)
      mod_info_server('GAMB_NYShotline', selector = selection, data = GAMBdata(), rownametitle = c("New York State Gambler's Hotline"), phone = T, website = T, email = F)
      mod_Accordion_server('GAMB_NtnlHotline', selector=selection, data=GAMBdata(), title = c('National Gambler Support Line'), Visible = T)
      mod_info_server('GAMB_NtnlHotline', selector = selection, data = GAMBdata(), rownametitle = c('National Gambler Support Line'), phone = T, website = T, email = F)
      mod_Accordion_server('GAMB_gambAnonymous', selector=selection, data=GAMBdata(), title = c('Gamblers Anonymous'), Visible = T)
      mod_info_server('GAMB_gambAnonymous', selector = selection, data = GAMBdata(), rownametitle = c('Gamblers Anonymous'), phone = F, website = T, email = F)
      mod_Accordion_server('GAMB_gambAnon', selector=selection, data=GAMBdata(), title = c('Gam-Anon'), Visible = T)
      mod_info_server('GAMB_gambAnon', selector = selection, data = GAMBdata(), rownametitle = c('Gam-Anon'), phone = F, website = T, email = F)
      mod_Accordion_server('GAMB_TxtLocator', selector=selection, data=GAMBdata(), title = c('Gambling Treatment Locator'), Visible = T)
      mod_info_server('GAMB_TxtLocator', selector = selection, data = GAMBdata(), rownametitle = c('OASAS Problem Gambling Treatment Locator'), phone = F, website = T, email = F)
      mod_Accordion_server('GAMB_Knowtheodds', selector=selection, data=GAMBdata(), title = c('Know the Odds'), Visible = T)
      mod_info_server('GAMB_Knowtheodds', selector = selection, data = GAMBdata(), rownametitle = c('Know the Odds'), phone = F, website = T, email = F)
      mod_Accordion_server('GAMB_GamFin', selector=selection, data=GAMBdata(), title = c('GamFin'), Visible = T)
      mod_info_server('GAMB_GamFin', selector = selection, data = GAMBdata(), rownametitle = c('GamFin'), phone = F, website = T, email = F)
    ...
    if(input$PMHselector == "Academic Resources"){
      ...
      mod_info_server('ACA_lib', selector = selection, data = Acadata(), rownametitle = c('University Libraries'), phone = T, website = T, email = F)
      ...
      mod_info_server('ACA_DAISS', selector = selection, data = Acadata(), rownametitle = c('Disability Access and Inclusion Student Services'), phone = T, website = T, email = F)
      mod_Accordion_server('ACA_Writing', selector=selection, data=Acadata(), title = c('Writing Center'), Visible = T)
      mod_info_server('ACA_Writing', selector = selection, data = Acadata(), rownametitle = c('Writing Center'), phone = T, website = T, email = F)
      mod_Accordion_server('ACA_Tutoring', selector=selection, data=Acadata(), title = c('Tutoring'), Visible = T)
      mod_info_server('ACA_Tutoring', selector = selection, data = Acadata(), rownametitle = c('Tutoring'), phone = T, website = T, email = F)
      mod_Accordion_server('ACA_Excel', selector=selection, data=Acadata(), title = c('Project Excel'), Visible = T)
      mod_info_server('ACA_Excel', selector = selection, data = Acadata(), rownametitle = c('Project Excel'), phone = T, website = T, email = F)
      mod_Accordion_server('ACA_CSTEP', selector=selection, data=Acadata(), title = c('CSTEP'), Visible = T)
      mod_info_server('ACA_CSTEP', selector = selection, data = Acadata(), rownametitle = c('Collegiate Science and Technology Entry Program (CSTEP)'), phone = T, website = T, email = F)
      mod_Accordion_server('ACA_SummerResearch', selector=selection, data=Acadata(), title = c('Summer Research Program'), Visible = T)
      mod_info_server('ACA_SummerResearch', selector = selection, data = Acadata(), rownametitle = c('University at Albany Summer Research Program'), phone = T, website = T, email = F)
      mod_Accordion_server('ACA_DOS', selector=selection, data=Acadata(), title = c('Dean of Students'), Visible = T)
      mod_info_server('ACA_DOS', selector = selection, data = Acadata(), rownametitle = c('Dean of Students'), phone = T, website = T, email = F)
      mod_Accordion_server('ACA_CareerServices', selector=selection, data=Acadata(), title = c('UAlbany Career Services'), Visible = T)
      mod_info_server('ACA_CareerServices', selector = selection, data = Acadata(), rownametitle = c('UAlbany Career Services'), phone = T, website = T, email = F)
      ...
      mod_info_server('Aca_International Student and Scholar Services', selector = selection, data = Acadata(), rownametitle = c('International Student and Scholar Services'), phone = T, website = T, email = T)
      ...
      mod_info_server('Aca_CURCE', selector = selection, data = Acadata(), rownametitle = c('Center for Undergraduate Research and Creative Engagement (CURCE)'), phone = F, website = T, email = F)
      mod_Accordion_server('Aca_ICA', selector=selection, data=Acadata(), title = c('International Crossroads Albany (ICA)'), Visible = T)
      mod_info_server('Aca_ICA', selector = selection, data = Acadata(), rownametitle = c('International Crossroads Albany (ICA)'), phone = F, website = T, email = F)
    ...
    if(input$PMHselector == "International Student Resources"){
      ...
      observeEvent(input$OffCampus,{
        ...
        if(input$OffCampus == F) {
          ...
          mod_info_server('INTNL_ISSS', selector = selection, data = INTNLdata(), rownametitle = c('International Student and Scholar Services'), phone = T, website = T, email = T)
          ...
          mod_info_server('INTNL_RISSE', selector = selection, data = INTNLdata(), rownametitle = c('RISSE (Refgeee and Immigrant Support Services of Emmaus)'), phone = T, website = T, email = F)
          mod_Accordion_server('INTNL_ICA', selector=selection, data=INTNLdata(), title = c('International Crossroads Albany (ICA)'), Visible = F)
          mod_info_server('INTNL_ICA', selector = selection, data = INTNLdata(), rownametitle = c('International Crossroads Albany (ICA)'), phone = F, website = T, email = F)
    ...
    if(input$PMHselector == "Food, Housing, & Financial"){
      ...
      mod_info_server('PurplePantry', selector = selection, data = FHFdata(), rownametitle = c('Purple Pantry'), phone = T, website = T, email = F)
      mod_Accordion_server('PurpleThreads', selector=selection, data=FHFdata(), title = c('Purple Threads'), Visible = T)
      mod_info_server('PurpleThreads', selector = selection, data = FHFdata(), rownametitle = c('Purple Threads'), phone = T, website = T, email = F)
      ...
      mod_info_server('FHF_SSS', selector = selection, data = FHFdata(), rownametitle = c('Supplemental Support Services'), phone = F, website = T, email = F)
      ...
      mod_info_server('FHF_HomelessnessLiason', selector = selection, data = FHFdata(), rownametitle = c('UAlbany Homelessness Liason'), phone = T, website = T, email = F)
      ...
      mod_info_server('FHF_The Food Pantries Food Connect Map', selector = selection, data = FHFdata(), rownametitle = c('The Food Pantries Food Connect Map'), phone = F, website = T, email = F)
      mod_Accordion_server('FHF_Capital Roots', selector=selection, data=FHFdata(), title = c('Capital Roots'), Visible = T)
      mod_info_server('FHF_Capital Roots', selector = selection, data = FHFdata(), rownametitle = c('Capital Roots'), phone = T, website = T, email = F)
      ...
      mod_info_server('FHF_VincdepaulFoodPantry', selector = selection, data = FHFdata(), rownametitle = c('St Vincent De Paul Food Pantry'), phone = T, website = T, email = F)
      ...
      mod_info_server('FHF_CapRegionCommResource', selector = selection, data = FHFdata(), rownametitle = c('Capital Region Community Resource'), phone = T, website = T, email = F)


      mod_Accordion_server('FHF_WERC', selector=selection, data=FHFdata(), title = c('Women’s Employment & Resource Center (WERC)'), Visible = T)
      mod_info_server('FHF_WERC', selector = selection, data = FHFdata(), rownametitle = c('Women’s Employment & Resource Center (WERC)'), phone = T, website = T, email = F)


      mod_Accordion_server('FHF_SNAP', selector=selection, data=FHFdata(), title = c('SNAP (Food Stamps)'), Visible = T)
      mod_info_server('FHF_SNAP', selector = selection, data = FHFdata(), rownametitle = c('SNAP (Food Stamps)'), phone = F, website = T, email = F)
      ...
      mod_info_server('FHF_RISSE', selector = selection, data = FHFdata(), rownametitle = c('RISSE (Refgeee and Immigrant Support Services of Emmaus)'), phone = T, website = T, email = F)
    ...
    if(input$PMHselector == "Legal Resources"){
      ...
      observeEvent(input$OffCampus,{
        ...
        if(input$OffCampus == F) {
          ...
          mod_info_server('Legal_UPD', selector = selection, data = Legaldata(), rownametitle = c('University Police (UPD)'), phone = T, website = T, email = F)
          mod_Accordion_server('LEGAL_SLS', selector=selection, data=Legaldata(), title = c('Student Legal Services'), Visible = T)
          mod_info_server('LEGAL_SLS', selector = selection, data = Legaldata(), rownametitle = c('Student Legal Services'), phone = T, website = T, email = F)
          mod_Accordion_server('LEGAL_LegalAID', selector=selection, data=Legaldata(), title = c('Legal Aid Society NE New York'), Visible = F)
          mod_info_server('LEGAL_LegalAID', selector = selection, data = Legaldata(), rownametitle = c('Legal Aid Society Northeastern New York'), phone = T, website = T, email = F)
          ...
          mod_info_server('Legal_RISSE', selector = selection, data = Legaldata(), rownametitle = c('RISSE (Refgeee and Immigrant Support Services of Emmaus)'), phone = T, website = T, email = F)
    ...
    if(input$PMHselector == "Hotlines"){
      ...
      mod_info_server('HL_FindAHelpline', selector = selection, data = HLdata(), rownametitle = c('Find a Helpline'), phone = F, website = T, email = F)
      mod_Accordion_server('HL_NYSsupport', selector=selection, data=HLdata(), title = c('New York State Support Line'), Visible = T)
      mod_info_server('HL_NYSsupport', selector = selection, data = HLdata(), rownametitle = c('New York State Support Line'), phone = T, website = T, email = F)
      mod_Accordion_server('HL_NYSsexassaultHL', selector=selection, data=HLdata(), title = c('24-Hour Sexual Assault Hotline'), Visible = T)
      mod_info_server('HL_NYSsexassaultHL', selector = selection, data = HLdata(), rownametitle = c('24-Hour Sexual Assault Hotline'), phone = T, website = T, email = F)
      mod_Accordion_server('HL_RAINN', selector=selection, data=HLdata(), title = c('RAINN Sexual Violence'), Visible = T)
      mod_info_server('HL_RAINN', selector = selection, data = HLdata(), rownametitle = c('RAINN Sexual Violence'), phone = T, website = T, email = F)
      mod_Accordion_server('HL_SmokersQuit', selector=selection, data=HLdata(), title = c("New York State Smoker's Quitline"), Visible = T)
      mod_info_server('HL_SmokersQuit', selector = selection, data = HLdata(), rownametitle = c("New York State Smoker's Quitline"), phone = T, website = T, email = F)
      mod_Accordion_server('HL_NYSgamb', selector=selection, data=HLdata(), title = c("New York State Gambler's Hotline"), Visible = T)
      mod_info_server('HL_NYSgamb', selector = selection, data = HLdata(), rownametitle = c("New York State Gambler's Hotline"), phone = T, website = T, email = F)
      mod_Accordion_server('HL_NtnlGAMB', selector=selection, data=HLdata(), title = c('National Gambler Support Line'), Visible = T)
      mod_info_server('HL_NtnlGAMB', selector = selection, data = HLdata(), rownametitle = c('National Gambler Support Line'), phone = T, website = T, email = F)
      ...
      mod_info_server('HL_SuicideLifeline', selector = selection, data = HLdata(), rownametitle = c('(988) National Suicide & Crisis Lifeline'), phone = T, website = T, email = F)
      mod_Accordion_server('Hotline_NYSQuitline', selector=selection, data=HLdata(), title = c('NYS Smokers Quit Line'), Visible = T)
      mod_info_server('Hotline_NYSQuitline', selector = selection, data = HLdata(), rownametitle = c('NY Quits - Smokers Quit Line'), phone = T, website = T, email = F)
      mod_Accordion_server('HL_CHAMP', selector=selection, data=HLdata(), title = c('CHAMP Program (OASAS)'), Visible = T)
      mod_info_server('HL_CHAMP', selector = selection, data = HLdata(), rownametitle = c('CHAMP Program (OASAS)'), phone = T, website = T, email = F)
      mod_Accordion_server('HL_CARELine', selector=selection, data=HLdata(), title = c('Capital CARELine'), Visible = T)
      mod_info_server('HL_CARELine', selector = selection, data = HLdata(), rownametitle = c('Capital CARELine'), phone = T, website = T, email = F)
